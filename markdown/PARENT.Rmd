...
# Tables
```{r tab.cap='Stations allocated and sampled this year.', tab.id='tab2',  tab.cap.style = "Table Caption"}
list_tables[[1]]
```


```{r tab.cap='Target numbers of length samples for each managed species.', tab.id='sample_sizes_tab',  tab.cap.style = "Table Caption"}
list_tables[[2]]
```
