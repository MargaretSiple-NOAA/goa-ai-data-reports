...
This is a test of the cross-refs in this doc (Table \@ref(tab:stations-allocated)).
...
```{r tab.cap='Target numbers of length samples for each managed species.', tab.id='length_sample_sizes',  tab.cap.style = "Table Caption"}
list_tables[[2]]
```
