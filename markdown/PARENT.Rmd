...
```{r echo=FALSE,tab.cap='Ex-vessel prices used to allocate stations in the AI 2022 bottom trawl survey. The prices used for station allocation in 2022 are from 2020.', tab.id='sp-prices',  tab.cap.style = "Table Caption"}
sp_prices %>% 
