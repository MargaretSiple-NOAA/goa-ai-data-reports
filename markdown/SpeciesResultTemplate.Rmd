...
-  The highest CPUEs were recorded in the {{inpfc_highest_cpue[1]}} and {{inpfc_highest_cpue[2]}} regions (Fig. `r officer::run_reference(paste0("cpue-",{{species_code}}))` and  Table `r officer::run_reference(paste0("table1-",{{species_code}}))`). 
