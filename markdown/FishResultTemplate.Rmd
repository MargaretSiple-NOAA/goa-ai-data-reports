...
```{r echo=FALSE,tab.cap='Summary by survey districts and depth intervals of {{year}} {{region}} trawl effort (number of hauls), number of hauls containing {{spp_name_informal}}, their mean CPUE and biomass estimates with lower and upper 95% confidence limits (CL), and average fish weight.', tab.id=paste0("table1-",{{species_code}}),  tab.cap.style = "Table caption",tab.align="left"}
