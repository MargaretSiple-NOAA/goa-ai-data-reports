...
This plot shows the full distribution of observed bottom temperatures in the survey. The heat colors show the quantiles of the distribution, and the shaded area is the shape of the full distribution. Surveys that are not 2-boat surveys are indicated by an asterisk (3-boat survey) or otherwise written in text.
