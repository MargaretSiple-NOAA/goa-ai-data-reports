...
There are `r nrow(report_species)` managed species or species groups in the `r SRVY_long` presented here.
...
:::notes
We also collected almost 8000 pairs of otoliths this summer from 16 groundfish species.
:::
...
:::notes
Overall species composition in `r maxyr` was similar to past years with arrowtooth flounder and POP dominating the catches. (NOTE: CHANGE THESE)
