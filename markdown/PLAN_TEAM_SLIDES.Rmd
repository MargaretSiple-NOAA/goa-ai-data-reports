...
-   `r SRVY` data are finalized as of **August 25th**
...
- Emphasis on differences from long-term mean (provides a better idea of stock status based on the index)
- asdf
...
```{r catchcomp}
knitr::include_graphics(path = here::here("output/AI_2024/figures/2024_biomass_catchcomp.png"))
```
...
```{r bottomtemp}
list_temperature[["bottom_temp_plot"]]
```
...
```{r}
knitr::include_graphics(path = here::here("output/AI_2024/tables/PercentChangeTable2.png"))
```
