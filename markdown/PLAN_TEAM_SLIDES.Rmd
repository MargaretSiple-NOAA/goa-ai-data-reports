...
Cpt Paulo da Cruz, first year on GOA survey
:::
...
:::notes
Both of our charter vessels have conducted the `r SRVY` survey several times and our skippers are highly experienced, hard bottom fishermen.
...
for (i in 1:5) { # nrow(report_species)
