...
Code to produce these plots and this presentation can be found on the [goa-ai-reports GitHub repo](https://www.github.com/afsc-gap-products/goa-ai-data-reports/).
...
for (i in 1:11) { # nrow(report_species)
  ...
  complex_sentence <- ifelse(grepl(species_code, pattern = "[A-Z]"),
                             paste("This complex includes:",
                                   complex_name_text$species[which(complex_name_text$complex==species_code)]),
                             "")
...
```{r}
knitr::include_graphics(path = here::here("output/GOA_2025/tables/PercentChangeTable.png"))
```
