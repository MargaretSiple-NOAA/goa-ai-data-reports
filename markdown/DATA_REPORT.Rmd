...
```{r fig.cap='Gear temperature measured at the headrope of the trawl. Larger brown points represent the median. Shaded distributions represent the density of measurements. Dotted lines show the mean gear temperature over the past 10 and 20 years.', fig.id='bottom-temp',  fig.cap.style = "Figure Caption", fig.width=6}
