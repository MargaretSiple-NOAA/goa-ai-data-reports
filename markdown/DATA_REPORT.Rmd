...
```{r fig.cap='Surface temperatures from the survey. Larger brown points represent the median, small black points represent individual hauls. Shaded distributions represent the density of measurements. Horizontal lines show the mean surface temperature over the past 10 and 20 years.', fig.id='surface-temp',  fig.cap.style = "Figure Caption", fig.width=6}
...
for (i in 1:nrow(report_species)) { # nrow(report_species)
  ...
  species_biomass <- paste0(species_biomass0, "&nbsp;", "t")
