...
```{r fig.cap='Surface temperatures from the survey. Larger brown points represent the median. Shaded distributions represent the density of measurements. Horizontal lines show the mean bottom (gear) temperature over the past 10 and 20 years.', fig.id='surface-temp',  fig.cap.style = "Figure Caption", fig.width=6}
