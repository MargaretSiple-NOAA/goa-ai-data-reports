...
```{r fig.cap='Surface temperatures as measured at the trawl. Larger brown points represent the median. Shaded distributions represent the density of measurements. Dotted lines show the mean bottom (gear) temperature over the past 10 and 20 years.', fig.id='surface-temp',  fig.cap.style = "Figure Caption", fig.width=6}
