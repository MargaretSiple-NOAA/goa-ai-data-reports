...
author: "Alexandra Dowlin, Margaret Siple, Bethany Riggle"
output:
...
for (i in 1:nrow(report_species)) { # 1:nrow(report_species)
  # 20:26 includes some complexes and some single-species stocks
