...
```{r fig.cap=paste("Diagram of the Poly Nor'eastern bottom trawl gear used in the",maxyr,survname_long, "survey"), fig.id='net-diagram',  fig.cap.style = "Figure Caption", fig.width = 6.5, dpi = 300, fig.asp={{net_asp}} }
...
list_tables[["allocated_sampled"]] |>
  ...
  hline(i = ~ break_position(`NMFS area`), 
