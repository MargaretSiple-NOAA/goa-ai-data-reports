...
# cpue_table_gdrive <- RODBC::sqlQuery(channel, "select survey_district, common_name species_name, round(cpue,1) cpue
# from SURVEY_DISTRICTS where rn <= 20 -- top 20 is hardcoded and dependent on cpue in descending order but doesn't need to be dynamic
