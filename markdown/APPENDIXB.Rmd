...
```{r echo=FALSE,tab.cap='Appendix Table B1. Fish and invertebrate species encountered and identified during the 2022 Aleutian Islands bottom trawl survey.', tab.id='b-specieslist',  tab.cap.style = "Table Caption"}
appB %>% 
  prep_appendix_b() %>%
